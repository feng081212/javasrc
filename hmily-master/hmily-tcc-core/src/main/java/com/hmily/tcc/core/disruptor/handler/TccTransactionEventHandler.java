...
public class TccTransactionEventHandler implements EventHandler<TccTransactionEvent> {
    ...
    @Override
    public void onEvent(TccTransactionEvent tccTransactionEvent,long sequence, boolean endOfBatch) throws Exception {
        if (tccTransactionEvent.getType() == EventTypeEnum.SAVE.getCode()) {
            ...
            TccTransaction tccTransaction = tccTransactionEvent.getTccTransaction();
